...
myConst=constants(lower_limit=390, upper_limit=700, T_factor=0.1, R_factor=0.1, max_DLC_thickness=150.0)
...
def create_structure():
 ...
 '''
    ...
    L1_thickness=random.uniform(90.0, 100.0)
    ...
    L3_thickness=random.uniform(3.0, 8.0)
    L3_thickness=float("{0:.1f}".format(L3_thickness))
    layer_three=Cr(L3_thickness)
...
'''
    ...
    LAg_thickness=random.uniform(90.0, 100.0)
    ...
    #LCr_thickness=random.uniform(3.0, 10.0)
    #LCr=float("{0:.1f}".format(LCr_thickness))
...
##                  min_wl=230, max_wl=2476)
    ...
    print 'Absorptance =%s' % float("{0:.4f}".format(Absorptance))
