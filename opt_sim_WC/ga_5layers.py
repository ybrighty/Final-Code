...
myConst=constants(lower_limit=390, upper_limit=700,
                  p1=1.3, p2=5, wanted_TSER=.65, max_DLC_thickness=150.0)
...
def create_structure():
 ...
 '''
    ...
    L1_thickness=random.uniform(3., 20.)  # 3 to 20 used to be
    ...
    L3_thickness=random.uniform(3., 20.)   # 3 to 20 used to be
    ...
    L5_thickness=random.uniform(10.0, myConst.max_DLC_thickness)
    L5_thickness=float("{0:.1f}".format(L5_thickness))
    layer_five=Al2O3(L5_thickness)
...
'''
    ...
    LDLC_thickness=random.uniform(10.0, myConst.max_DLC_thickness)
    LDLC=float("{0:.1f}".format(LDLC_thickness))

    LAl2O3_thickness=random.uniform(10.0, myConst.max_DLC_thickness)
