...
'''
    ...
    child_one=parent_one[0:5]+parent_two[5:7] +(L7_thickness, L8_thickness, L9_thickness)
    
    child_two=parent_two[0:5]+parent_one[5:7] +(L9_thickness, L8_thickness, L7_thickness)

        
    child_three=child_one[:1]+child_one[7:]+child_one[4:5]+child_one[3:4]+child_one[2:3]+child_one[5:7]+child_one[1:2]
    
    child_four=child_two[:1]+child_two[7:8]+child_two[2:3]+child_two[5:6]+child_two[4:5]+child_two[3:4]+child_two[6:7]+child_two[1:2]+child_two[8:]
